...
# RailsAdmin config file. Generated on October 27, 2011 22:33
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Kegeratorstat Us', 'Admin']
  ...
  config.excluded_models << [Keg, Kegerator, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Beer, Brewery, Keg, KegType, Kegerator, User]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Beer do
  #   # Found associations:
  #   field :brewery, :belongs_to_association
  #   field :kegs, :has_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
  #   field :brewery_id, :integer        # Hidden
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Brewery do
  #   # Found associations:
  #   field :beers, :has_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
  #   field :created_at, :datetime
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Keg do
  #   # Found associations:
  #   field :keg_type, :belongs_to_association
  #   field :kegerator, :belongs_to_association
  #   field :beer, :belongs_to_association
  #   field :user, :has_one_association
  #   # Found columns:
  #   field :id, :integer
  #   field :keg_type_id, :integer        # Hidden
  #   field :kegerator_id, :integer        # Hidden
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   field :beer_name, :string
  #   field :added_at, :date
  #   field :finished_at, :date
  #   field :beer_id, :integer        # Hidden
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   field :capacity_in_gallons, :float
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :kegerators, :has_many_association
  #   field :kegs, :has_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :email, :string
